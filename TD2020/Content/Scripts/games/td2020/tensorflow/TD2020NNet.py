...
class TD2020NNet:
    def __init__(self, game, args):
        ...
        with self.graph.as_default():
            ...
            h_conv1 = relu(batch_normalization(self.conv2d(x_image, args.num_channels, 'same'), axis=3, training=self.isTraining))  # batch_size  x board_x x board_y x num_channels
            h_conv2 = relu(batch_normalization(self.conv2d(h_conv1, args.num_channels, 'same'), axis=3, training=self.isTraining))  # batch_size  x board_x x board_y x num_channels
