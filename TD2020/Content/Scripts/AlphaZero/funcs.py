...
def play_matches_between_versions(env, run_version, player1version, player2version, episodes, logger, turns_until_tau0, goes_first=0):
    if player1version == -1:
    ...
    scores, memory, points, sp_scores = play_matches(player1, player2, episodes, logger, turns_until_tau0, None, goes_first)

    return scores, memory, points, sp_scores


def play_matches(player1, player2, episodes, logger, turns_until_tau0, memory=None, goes_first=0):
    env = Game()
