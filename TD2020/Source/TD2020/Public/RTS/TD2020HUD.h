...
#include "TD2020HUD.generated.h"


/**
* HUD with TD2020 features, such as showing a selection frame.
*/
UCLASS()
class TD2020_API ATD2020HUD : public AHUD
{
	GENERATED_BODY()
...
public:
	...
	UPROPERTY(BlueprintReadWrite, EditAnywhere, Category = "TD2020|Health Bars")
	...
	UPROPERTY(BlueprintReadWrite, EditAnywhere, Category = "TD2020|Construction Progress Bars")
	...
	UPROPERTY(BlueprintReadWrite, EditAnywhere, Category = "TD2020|Production Progress Bars")
    ...
    UPROPERTY(BlueprintReadWrite, EditAnywhere, Category = "TD2020|Floating Combat Texts")
	...
	/** Event for drawing the construction progress bar for the specified unit. */
	UFUNCTION(BlueprintImplementableEvent, Category = "TD2020", meta = (DisplayName = "DrawConstructionProgressBar"))
    ...
    /** Event for drawaing a floating combat text. */
    UFUNCTION(BlueprintImplementableEvent, Category = "TD2020", meta = (DisplayName = "DrawFloatingCombatText"))
	...
	/** Event for drawing an effect for the currently hovered actor. */
	UFUNCTION(BlueprintImplementableEvent, Category = "TD2020", meta = (DisplayName = "DrawHoveredActorEffect"))
	void ReceiveDrawHoveredActorEffect(AActor* HoveredActor);

	/** Event for drawing the health bar for the specified actor. */
	UFUNCTION(BlueprintImplementableEvent, Category = "TD2020", meta = (DisplayName = "DrawHealthBar"))
	...
	/** Event for drawing the production progress bar for the specified unit. */
	UFUNCTION(BlueprintImplementableEvent, Category = "TD2020", meta = (DisplayName = "DrawProductionProgressBar"))
	...
	/** Event for drawing the selection frame because the mouse is being dragged. */
	UFUNCTION(BlueprintImplementableEvent, Category = "TD2020", meta = (DisplayName = "DrawSelectionFrame"))
