...
#include "TD2020MinimapWidget.generated.h"


class ATD2020MinimapVolume;
...
class TD2020_API UTD2020MinimapWidget : public UUserWidget
{
	GENERATED_UCLASS_BODY()

public:
	/** Brush for drawing the background of the current map. */
	UPROPERTY(EditAnywhere, BlueprintReadOnly, Category = "TD2020|Background")
	FSlateBrush MinimapBackground;

	/** Brush for drawing own units on the minimap. */
	UPROPERTY(EditAnywhere, BlueprintReadOnly, Category = "TD2020|Units")
	...
	UPROPERTY(EditAnywhere, BlueprintReadOnly, Category = "TD2020|Vision")
	...
	UPROPERTY(EditAnywhere, BlueprintReadWrite, Category = "TD2020|Background")
	bool bDrawBackground = true;

	/** Whether to draw unit dots on the minimap, with OwnUnitsBrush, EnemyUnitsBrush and NeutralUnitsBrush. */
	UPROPERTY(EditAnywhere, BlueprintReadWrite, Category = "TD2020|Units")
	...
	UPROPERTY(EditAnywhere, BlueprintReadWrite, Category = "TD2020|Vision")
	bool bDrawVision = true;

	/** Whether to show the current camera frustum on the minimap. */
	UPROPERTY(EditAnywhere, BlueprintReadWrite, Category = "TD2020|Camera")
	...
	UFUNCTION(BlueprintImplementableEvent, Category = "TD2020", meta = (DisplayName = "OnDrawUnit"))
...
private:
	bool bMouseDown;
	ATD2020MinimapVolume* MinimapVolume;
	...
	bool ViewportToWorld(ATD2020PlayerController* Player, const FVector2D& ViewportPosition, FVector& OutWorldPosition) const;
